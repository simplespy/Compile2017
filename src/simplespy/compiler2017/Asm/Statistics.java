...
public class Statistics {
    protected Map<Register, Integer> registerUsage = new LinkedHashMap<>();
    protected Map<String, Integer> insnUsage = new LinkedHashMap<>();
    protected Map<Symbol, Integer> symbolUsage = new LinkedHashMap<>();
